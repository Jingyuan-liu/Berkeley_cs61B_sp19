...
public class LinkedListDequeTest {
	...
	public static void testGet(){
		...
		System.out.println(lld2.getRecursive(1));
		System.out.println(lld2.getRecursive(2));
		System.out.println(lld2.getRecursive(3));
		System.out.println(lld2.getRecursive(4));
		System.out.println(lld2.getRecursive(-1));
	}
